...
namespace DSM
{
    public class ReadMe
    {
        ...
        /*  
        *  D:\Suhas\Live Projects\DSM\DSM\ReadMe.cs
        *   Installation packages for new project and setup
        *   
        *   ---for sql server
        *   
        *   vs > Scaffold-DbContext "Server=TCP:SRKSDEV007\SQLEXPRESS,1236;Database=DSM;user id=sa;password=srks4$;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer -f
        *   vs > Scaffold-DbContext "Server=TCP:13.233.129.21,8090;Database=DSM;user id=sa;password=srks4$;" Microsoft.EntityFrameworkCore.SqlServer -f
        *   
        ...
        *   vs > Install-Package NETCore-log4net -Version 2.0.0
